    ...
    <div className='container max-w-full min-h-screen mb-4 space-y-8 md:space-y-28 md:mb-0' id='testimonials'>
        ...
        <div className='flex flex-col items-center justify-center space-x-0 space-y-4 md:space-x-10 md:flex-row md:space-y-0'>
            ...
            <div className='flex flex-col items-center p-4 border-2 border-primary rounded-2xl w-full md:w-[500px] md:h-[320px] h-full'>
                ...
                <img src={stars} className='w-[90px] h-[15px] md:w-[145px] md:h-[25px]' alt='Stars' />
                <img src={quote} alt='Quote' />
                <p className='text-[12px] lg:text-[16px]'>Very clean and safe ang clinic. We liked it because it is located outside the hospital. Very helpful and considerate also si Dra. Rejano and my 3 kids love her. I would highly recommend this clinic.</p>
            </div>
            <div className='flex flex-col items-center p-4 border-2 border-primary rounded-2xl  w-full md:w-[500px] h-full md:h-[320px]'>
                ...
                <img src={stars} className='w-[90px] h-[15px] md:w-[145px] md:h-[25px]' alt='Stars' />
                <img src={quote} alt='Quote' />
                <p className='text-[12px] lg:text-[16px]'>Beautiful Doctor at Mabait and Doctor. All your concerns will be answered. Our trusted pedia.</p>
            </div>
        </div>
    </div>
  )
