...
const Contact = () => {
  return (
    ...
    className='container max-w-full min-h-screen mt-8 mb-8 space-y-8 md:mb-0 md:space-y-10' id='contact'>
        ...
        className='shadow-md rounded-2xl md:w-[920px] md:h-[600px] w-[320px] h-[500px]' allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
