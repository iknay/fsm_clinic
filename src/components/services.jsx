...
const Services = () => {
  return (
    <div className='flex flex-col max-w-full -space-y-8 h-[125vh] lg:space-y-10 bg-image' id='services'>
        ...
        <div className='flex items-center justify-center flex-shrink'>
            <div className='grid grid-rows lg:grid-cols-3 md:gap-x-4 gap-x-0'>
                <Pediatrics/>
                <InternalMed/>
                <Gyne/>
                <Ent/>
